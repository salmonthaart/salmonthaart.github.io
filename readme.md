...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="container">
                ...
                <div class="updates">
                    ...
                    <div class="inner">
                        <div class="update">07.25.24 Various small changes, including a new Credits page!</div>
                    ...
                    <div class="inner" style="padding:4px 10px;">
                        <table>
                            <tbody>
                                ...
                                <tr style="display:flex;">
                                    <td><img src="https://adilene.neocities.org/images/bullet2.gif" class="bullet" draggable="false"></td><td><a href="/pages/figures.html" target="frame">Figures</a></td>
                                </tr>
                                <tr style="display:flex;">
                                ...
                                <tr style="display:flex;">
                                    <td><img src="https://adilene.neocities.org/images/bullet2.gif" class="bullet" draggable="false"></td><td><a href="/pages/credits.html" target="frame">Credits</a></td>
                                </tr>
                                <tr style="display:flex;">
                ...
                <div class="stats">
                    ...
                    <div class="inner" style="display:flex; flex-direction:column; justify-content:space-between; height:100%; text-align:center; color:var(--color);">
                        <div id="root">...</div>
                        <div>Views: <span id="viewcount"></span></div>
                        <div>Hits: <span id="hitcount"></span></div>
                        <div>Last Updated: <span id="lastupdated"></span></div>
                        <img src="https://files.catbox.moe/ctl9r4.png" style="margin:auto; margin-top:6px;" draggable="false">
                    </div>
                </div>
                    ...
                    <div class="inner" style="padding:0;">
                        <div id="musicplayer">
                            ...
                            <div style="display:flex; flex-direction:column; justify-content:space-between; align-content:space-between; height:110px;">
                                ...
                                <div class="volume">
                                    <div style="margin-right:5px;">Volume</div>
        ...
        <!-- the below code does not track you
